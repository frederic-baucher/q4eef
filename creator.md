...
#### Examples
- $\textcolor{red}{\text{SEMAT}}\textcolor{orange}{\text{0094}}\textcolor{black}{\text{.}}\textcolor{grey}{\text{serious-games}}\textcolor{black}{\text{.}}\textcolor{green}{\text{quizizz}}\textcolor{black}{\text{.}}\textcolor{purple}{\text{html}}$ or $\textcolor{red}{\text{SEMAT}}\textcolor{orange}{\text{0094}}\textcolor{black}{\text{.}}\textcolor{grey}{\text{serious-games}}\textcolor{blue}{\text{-fr}}\textcolor{black}{\text{.}}\textcolor{pink}{\text{mcp}}\textcolor{green}{\text{quizizz}}\textcolor{black}{\text{.}}\textcolor{purple}{\text{html}}$
  - a file containing an exercise (by default, the type is mcp and the language is english) created in the SEMAT repository, under id 0094.
