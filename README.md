...
Use cases :
- Convert exercise : in case the exported format is not very convenient as a native pivot (like [Quizizz]([https://raw.githubusercontent.com/frederic-baucher/q4eef/main/doc/export_from_quizizz.md](https://github.com/frederic-baucher/q4eef/blob/main/doc/export_from_quizizz.md))), the creator can convert it with a dedicated tools (regex tools, spreadsheet, ...).
